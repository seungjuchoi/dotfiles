...
k.set('n', '[b', ':bp<CR>', {silent = true})
k.set('n', ']b', ':bn<CR>', {silent = true})
k.set('n', '[t', ':tabp<CR>', {silent = true})
k.set('n', ']t', ':tabn<CR>', {silent = true})
...
k.set('n', "<leader>df", ":DiffviewOpen<CR>", {silent = true})
k.set('n', "<leader>dx", ":DiffviewClose<CR>", {silent = true})
k.set('n', "<leader>wa", ":set wrap<CR>", {silent = true})
k.set('n', "<leader>wx", ":set nowrap<CR>", {silent = true})
