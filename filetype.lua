vim.cmd("autocmd FileType python map <buffer> <F5> :update<CR>:TermExec cmd='python3 %'<CR>")
vim.cmd("autocmd FileType python imap <buffer> <F5> <esc>:update<CR>:TermExec cmd='python3 % '<CR>")
vim.cmd("autocmd FileType python map <buffer> <F6> :update<CR>:TermExec cmd='python3 %'")
vim.cmd("autocmd FileType python imap <buffer> <F6> <esc>:update<CR>:TermExec cmd='python3 % '")
